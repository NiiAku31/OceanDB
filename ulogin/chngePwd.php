...
<body>
	...
	<div  class="bg-dark pt-3 pb-3">
		...
		<a href="../cart.php"><button type="button" class="btn btn-light mr-3" style="float:right;">CART</button></a>
	...
	<div class="container bg-dark text-light text-center main">
		...
		<table align="center" class="mt-5 mb-4 text-right">
			<form action="chngePwd.php" method="post">
				...
				<tr align="center">
					<td colspan="2"><input type="submit" name="submit" value="Change Password" class=" mt-5 btn btn-primary"></td>
					</t>
			</form>
		</table>
	</div>
