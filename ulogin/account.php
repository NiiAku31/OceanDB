...
<body>
	...
	<div class="container bg-dark text-light text-center main">
		...
		<table align="center">
			...
			<tr>
				<td><a href="editInfo.php"><button class=" bg-primary btn btn-primary">Edit Information</button></a></td>
				<td><a href="chngePwd.php"><button class="bg-primary btn btn-primary">Change Password</button></a></td>
			</tr>
		</table>
	</div>
